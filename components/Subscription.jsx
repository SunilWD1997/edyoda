...
const{setRate, rate} = useContext(rateContext)
  ...
  return (
   ...
   <label className="w-[100%] cursor-pointer border-[3px]  rounded-[4px] relative" onClick={()=>{setRate(alert('this offer is expired')), setRate(179)}}>
        <input type="radio" className=" peer sr-only" name="pricing" />

        <div className=" max-w-xl rounded-md bg-white py-1 px-3  text-gray-600 ring-2 ring-transparent transition-all   ">
